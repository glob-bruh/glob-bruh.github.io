...
1) Go to Go to the Main Menu.
2) Click `New Game`.
3) Confirm the warning dialogue and then click `Continue`.

You should find yourself at the very beginning of the game.
